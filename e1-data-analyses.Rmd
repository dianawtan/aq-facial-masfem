...
dataMorg_long <- gather(dataMorgCleaned, "RaterID", "mascRating", starts_with("Rater"))
dataForg_long <- gather(dataForgCleaned, "RaterID", "femRating", starts_with("Rater"))

```


```{r lme-models, echo=FALSE, message=FALSE, warning=TRUE, include=FALSE}
## LME models: AQ scores and masculinity/femininity ratings
